<template>
    <div>
        <headerNav title="收支明细(现金/积分)"/>
        <div style="height:10px;"></div>
        <van-cell-group>
            <van-cell title="充值积分: +120元  " value="2018-08-16 09:42"/>
            <van-cell title="现金提现: +20元  " value="2018-08-16 09:42"/>
            <van-cell title="积分兑换: +2元  " value="2018-08-16 09:42"/>
            <van-cell title="购买商品: -220元  " value="2018-08-16 09:42"/>
            <van-cell title="商品推广: +20分  " value="2018-08-16 09:42"/>
            <van-cell title="每日签到: +2分  " value="2018-08-16 09:42"/>
        </van-cell-group>     
        <!-- 
        <van-cell-group>
        <van-field
